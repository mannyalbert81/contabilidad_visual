    ...
    public partial class conComprobantesEgresos : System.Web.UI.Page
    {
        ...
        protected void CrystalReportViewer1_Init(object sender, EventArgs e)
        {
            ...
            string where = "ccomprobantes.id_usuarios = usuarios.id_usuarios AND dcomprobantes.id_ccomprobantes = ccomprobantes.id_ccomprobantes AND "+
                "entidades.id_entidades = ccomprobantes.id_entidades AND usuarios.id_rol = rol.id_rol AND "+
                "tipo_comprobantes.id_tipo_comprobantes = ccomprobantes.id_tipo_comprobantes AND plan_cuentas.id_plan_cuentas = dcomprobantes.id_plan_cuentas AND "+
                "forma_pago.id_forma_pago = ccomprobantes.id_forma_pago ";
